...
export default function VideoListNew() {
  ...
  useEffect(() => {
    if (isError && errorMessage) {
      ...
      // Set retry callback
      setErrorModalRetryCallback(() => {
        // IMPORTANT: Preserve downloaded/offline videos when retrying
        // Using resetApiVideosOnly prevents clearing localVideos so the error modal
        // will continue to offer the "Show Offline Videos" option on repeated failures.
